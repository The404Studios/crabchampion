...
public:
	...
	struct FAnimNode_Slot                         AnimGraphNode_Slot_1;                              // 0x0CC8(0x0048)()
...
static_assert(sizeof(USK_Crab_AnimBP_Enemy_C) == 0x000D60, "Wrong size on USK_Crab_AnimBP_Enemy_C");
...
static_assert(offsetof(USK_Crab_AnimBP_Enemy_C, AnimGraphNode_Slot_1) == 0x000CC8, "Member 'USK_Crab_AnimBP_Enemy_C::AnimGraphNode_Slot_1' has a wrong offset!");
static_assert(offsetof(USK_Crab_AnimBP_Enemy_C, AnimGraphNode_Slot) == 0x000D10, "Member 'USK_Crab_AnimBP_Enemy_C::AnimGraphNode_Slot' has a wrong offset!");
