...
static_assert(sizeof(UUI_BossHealthBar_OLD_C) == 0x0003B0, "Wrong size on UUI_BossHealthBar_OLD_C");
...
static_assert(offsetof(UUI_BossHealthBar_OLD_C, Image_3) == 0x000378, "Member 'UUI_BossHealthBar_OLD_C::Image_3' has a wrong offset!");
static_assert(offsetof(UUI_BossHealthBar_OLD_C, Image_4) == 0x000380, "Member 'UUI_BossHealthBar_OLD_C::Image_4' has a wrong offset!");
static_assert(offsetof(UUI_BossHealthBar_OLD_C, Image_8) == 0x000388, "Member 'UUI_BossHealthBar_OLD_C::Image_8' has a wrong offset!");
static_assert(offsetof(UUI_BossHealthBar_OLD_C, Image_9) == 0x000390, "Member 'UUI_BossHealthBar_OLD_C::Image_9' has a wrong offset!");
static_assert(offsetof(UUI_BossHealthBar_OLD_C, Image_10) == 0x000398, "Member 'UUI_BossHealthBar_OLD_C::Image_10' has a wrong offset!");
static_assert(offsetof(UUI_BossHealthBar_OLD_C, Image_11) == 0x0003A0, "Member 'UUI_BossHealthBar_OLD_C::Image_11' has a wrong offset!");
static_assert(offsetof(UUI_BossHealthBar_OLD_C, Image_130) == 0x0003A8, "Member 'UUI_BossHealthBar_OLD_C::Image_130' has a wrong offset!");
