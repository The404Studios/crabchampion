...
static_assert(alignof(CrabHarvestArea_MulticastOnCountdownUpdated) == 0x000001, "Wrong alignment on CrabHarvestArea_MulticastOnCountdownUpdated");
static_assert(sizeof(CrabHarvestArea_MulticastOnCountdownUpdated) == 0x000001, "Wrong size on CrabHarvestArea_MulticastOnCountdownUpdated");
static_assert(offsetof(CrabHarvestArea_MulticastOnCountdownUpdated, PercentComplete) == 0x000000, "Member 'CrabHarvestArea_MulticastOnCountdownUpdated::PercentComplete' has a wrong offset!");
...
static_assert(sizeof(CrabPC_ClientNotifyDamageDealt) == 0x000050, "Wrong size on CrabPC_ClientNotifyDamageDealt");
...
static_assert(offsetof(CrabPC_ClientNotifyDamageDealt, DamageHitType) == 0x000048, "Member 'CrabPC_ClientNotifyDamageDealt::DamageHitType' has a wrong offset!");
...
public:
	...
	bool                                          bSaveAutoSave;                                     // 0x0030(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(CrabPC_ClientOnEnteredPortal) == 0x000038, "Wrong size on CrabPC_ClientOnEnteredPortal");
...
static_assert(offsetof(CrabPC_ClientOnEnteredPortal, bSaveAutoSave) == 0x000030, "Member 'CrabPC_ClientOnEnteredPortal::bSaveAutoSave' has a wrong offset!");
...
static_assert(sizeof(CrabPC_ClientOnReceivedChatMessage) == 0x000018, "Wrong size on CrabPC_ClientOnReceivedChatMessage");
static_assert(offsetof(CrabPC_ClientOnReceivedChatMessage, PS) == 0x000000, "Member 'CrabPC_ClientOnReceivedChatMessage::PS' has a wrong offset!");
static_assert(offsetof(CrabPC_ClientOnReceivedChatMessage, ChatMessage) == 0x000008, "Member 'CrabPC_ClientOnReceivedChatMessage::ChatMessage' has a wrong offset!");
...
static_assert(alignof(CrabPlayerC_MulticastAbility) == 0x000004, "Wrong alignment on CrabPlayerC_MulticastAbility");
static_assert(sizeof(CrabPlayerC_MulticastAbility) == 0x00000C, "Wrong size on CrabPlayerC_MulticastAbility");
static_assert(offsetof(CrabPlayerC_MulticastAbility, InAbilityTelegraphLoc) == 0x000000, "Member 'CrabPlayerC_MulticastAbility::InAbilityTelegraphLoc' has a wrong offset!");
...
static_assert(alignof(CrabPlayerC_ServerAbility) == 0x000004, "Wrong alignment on CrabPlayerC_ServerAbility");
static_assert(sizeof(CrabPlayerC_ServerAbility) == 0x00000C, "Wrong size on CrabPlayerC_ServerAbility");
static_assert(offsetof(CrabPlayerC_ServerAbility, InAbilityTelegraphLoc) == 0x000000, "Member 'CrabPlayerC_ServerAbility::InAbilityTelegraphLoc' has a wrong offset!");
...
static_assert(alignof(CrabPlayerC_ServerApplyEnhancement) == 0x000008, "Wrong alignment on CrabPlayerC_ServerApplyEnhancement");
static_assert(sizeof(CrabPlayerC_ServerApplyEnhancement) == 0x000008, "Wrong size on CrabPlayerC_ServerApplyEnhancement");
static_assert(offsetof(CrabPlayerC_ServerApplyEnhancement, InventoryDA) == 0x000000, "Member 'CrabPlayerC_ServerApplyEnhancement::InventoryDA' has a wrong offset!");
...
static_assert(alignof(CrabPlayerC_ServerSetActiveInteractable) == 0x000008, "Wrong alignment on CrabPlayerC_ServerSetActiveInteractable");
static_assert(sizeof(CrabPlayerC_ServerSetActiveInteractable) == 0x000008, "Wrong size on CrabPlayerC_ServerSetActiveInteractable");
static_assert(offsetof(CrabPlayerC_ServerSetActiveInteractable, NewActiveInteractable) == 0x000000, "Member 'CrabPlayerC_ServerSetActiveInteractable::NewActiveInteractable' has a wrong offset!");
...
static_assert(alignof(CrabSpectatorC_ClientSpectatePlayer) == 0x000008, "Wrong alignment on CrabSpectatorC_ClientSpectatePlayer");
static_assert(sizeof(CrabSpectatorC_ClientSpectatePlayer) == 0x000010, "Wrong size on CrabSpectatorC_ClientSpectatePlayer");
static_assert(offsetof(CrabSpectatorC_ClientSpectatePlayer, PlayerToSpectate) == 0x000000, "Member 'CrabSpectatorC_ClientSpectatePlayer::PlayerToSpectate' has a wrong offset!");
static_assert(offsetof(CrabSpectatorC_ClientSpectatePlayer, bShowSpectatingUI) == 0x000008, "Member 'CrabSpectatorC_ClientSpectatePlayer::bShowSpectatingUI' has a wrong offset!");
