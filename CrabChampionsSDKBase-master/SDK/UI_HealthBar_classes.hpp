...
public:
	...
	class UImage*                                 Image_130;                                         // 0x0378(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UTextBlock*                             Text;                                              // 0x0380(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
static_assert(sizeof(UUI_HealthBar_C) == 0x000388, "Wrong size on UUI_HealthBar_C");
...
static_assert(offsetof(UUI_HealthBar_C, Image_130) == 0x000378, "Member 'UUI_HealthBar_C::Image_130' has a wrong offset!");
static_assert(offsetof(UUI_HealthBar_C, Text) == 0x000380, "Member 'UUI_HealthBar_C::Text' has a wrong offset!");
